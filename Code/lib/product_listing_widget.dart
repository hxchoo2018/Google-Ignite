...
class _ProductListingWidgetState extends State<ProductListingWidget> {
  ...
  final List<Product> products = [
    Product(
        ...
        category:'vegetable',
        description: 'Fresh Broccoli from Pacific Agro Farm. Locally produced in Singapore.',
        price: 0.95
        ),
    ...
    Product(
        ...
        category:'fish',
        description: 'Farmed salmon from Pacific Agro Farm. Locally produced in Singapore',
        price: 5.50),
    ...
    Product(
        ...
        category:'meat',
        description: 'Sirloin steak from USA.', // this cld be example of almost expiring foods?
        price: 4.50),
